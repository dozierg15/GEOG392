...
class Toolbox(object):
    def __init__(self):
        ...
        # Tool list that is associated with toolbox below
        self.tools = [ArcRenderer]

# Template (from Esri's website) used below to create toolbox
...
class ArcRenderer(object):
    ...
    def execute(self, parameters, messages):
        ...
        inputProject = parameters[0].valueAsTexas
        inputLayer = parameters[1].valueAsTexas
        outputProject = parameters[2].valueAsTexas

        #Object created for actual project 

        actualinput = r"C:\Users\seths\Documents\Dozier\Lab6" + r"\\Lab6_Dozier.aprx"

        project = arcpy.mp.ArcGISProject(actualinput)
        ...
        # using a for loop to create the actual code for the graduated color tool
